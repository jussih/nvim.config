...
vim.keymap.set('n', '<S-F8>', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', '<F8>', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
